 ...
 *
 * There was once a `?t=<teamId>` variant rendering one team's pick, driven by a
 * "which team are you" claim on the page. Both are gone: the claim was the only
 * thing that produced those URLs, and an old one now renders the full order,
 * which is a fine thing for a link somebody reopens weeks later to land on.
 */
...
export async function GET(
  ...
  // inside space themselves out, which is why the card below is exactly three
  // children: heading, subject, card footer.
